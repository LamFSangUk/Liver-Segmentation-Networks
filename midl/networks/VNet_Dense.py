...
from midl.layers.Densenet import DenseBlockCompressed
...
def _make_conv_layer(in_channels, n_convs):
    ...
    for i in range(n_convs):
        ...
        layers.append(DenseBlockCompressed(in_channels=in_channels, out_channels=in_channels))
...
class DownTransition(nn.Module):
    def __init__(self, in_channels, n_convs):
        ...
        self.conv_block = DenseBlockCompressed(n_convs, out_channels, out_channels//n_convs,
                                               DenseLayer)
...
class VNet_Dense(nn.Module):
    def __init__(self):
        super(VNet_Dense, self).__init__()
        ...
        self.down_tr128 = DownTransition(in_channels=64, n_convs=4)
        self.down_tr256 = DownTransition(in_channels=128, n_convs=4)

...
from midl.layers.MPRBlock import MPRBlock
...
def _make_conv_layer(in_channels, n_convs):
    ...
    for i in range(n_convs):
        ...
        layers.append(MPRBlock(in_channels=in_channels, out_channels=in_channels))
...
class VNet_MPR(nn.Module):
    def __init__(self):
        super(VNet_MPR, self).__init__()
